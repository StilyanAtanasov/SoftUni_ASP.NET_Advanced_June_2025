  ...
  .addEventListener(`click`, async function () {
    ...
    try {
      ...
      if (response.ok) {
        ...
        throw new Error(data.Quantity || `Failed to purchase ticket.`);
      } else {
